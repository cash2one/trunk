...
import com.shandagames.android.widget.PinnedHeaderListView.PinnedHeaderAdapter;
...
public class PinnedHeaderActivity extends BaseActivity {
	...
	private void setupListView() {
	    ...
	    listView.setPinnedHeaderView(LayoutInflater.from(this).inflate(R.layout.pinnedheader_list_header, listView, false));
