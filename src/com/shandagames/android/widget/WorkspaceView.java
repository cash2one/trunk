...
public class WorkspaceView extends ViewGroup {
	...
	/**
	 * Configura los tabs de navegacin para que se autoseleccionen al cambiar de
	 * pantalla
	 * 
	 * 100% opcional.
	 * 
	 ...
	 * @param drawables
	 */
	public void configTabs(LinearLayout linear, int tabDrawable,
			int selectedTabDrawable, int tabFontColor,
			int selectedTabFontColor, String[] tabTitles) {
		configTabs(linear, tabDrawable, selectedTabDrawable, tabFontColor,
	...
	public void configTabs(LinearLayout linear, int tabDrawable,
			int selectedTabDrawable, int tabFontColor,
			int selectedTabFontColor, String[] tabTitles, int[] drawables,
	...
	public void configTabs(LinearLayout linear, int tabDrawable,
			int selectedTabDrawable, int tabFontColor, int selectedTabFontColor) {
	...
	public void addView(View child, String tabTitle, int drawable,
			int drawablePosition) {
	...
	public void addTab(String s, int drawable, int drawablePosition,
			Context context) {
		final Button btn = new Button(context);
		btn.setLayoutParams(new LinearLayout.LayoutParams(
				LayoutParams.WRAP_CONTENT, LayoutParams.FILL_PARENT, 1));
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (wallpaperLoaded) {
			...
			wallpaper = centerToFit(wallpaper, width,
	...
	public void scrollToScreen(int whichScreen) {
		...
		// Log.d(TAG, "newX=" + newX + " scrollX=" + getScrollX() + " delta=" +
		// delta + " abs=" + (Math.abs(delta) * 2));
		scroller.startScroll(getScrollX(), 0, delta, 0, Math.abs(delta) * 1);
		invalidate();
		redrawTabs(nextScreen);
