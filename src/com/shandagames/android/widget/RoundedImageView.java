...
/**
 * An ImageView that allows a pixel corner radius to be specified. The image's
 * corners will be rounded to this radius, with transparent behind the image.
 * 
 * <b>WARNING:</b> This is only supported for bitmap image sources. If other
 * types of drawable are set as the image source, the corners <b>will not be rounded.</b>
 */
