...
public class HorizontalTabView extends HorizontalScrollView implements OnClickListener {
    ...
    public void addTab(Tab tab) {
        ...
        int divWidth = (int) UIUtils.dip2px(getContext(), 1);
        int divTopMargin = (int) UIUtils.dip2px(getContext(), 12);
        int divHeight = (int) UIUtils.dip2px(getContext(), 24);;
        
        int tabPad = (int) UIUtils.dip2px(getContext(), 16);;
        ...
        if (mTextViews.size() > 0) {
            ...
            divider.setBackgroundColor(Color.parseColor("#565656"));
