...
/**
 * @file TextViewWrap.java
 * @create 2012-10-31 下午5:14:21
 * @author lilong
 * @description 自定义文本标签，自动换行
 */
public class TextViewWrap extends View {
	...
	public TextViewWrap(Context context, AttributeSet attrs, int defStyle) {
	...
	protected void onDraw(Canvas canvas) {
		...
		// 文本自动换行
		String[] texts = autoSplit(text, mPaint, getWidth() - 5);
